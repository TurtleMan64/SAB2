...
{
    vertexShaderId   = LoaderGL::loadShader("res/Shaders/particles/ParticleVert.glsl", GL_VERTEX_SHADER);
    fragmentShaderId = LoaderGL::loadShader("res/Shaders/particles/ParticleFrag.glsl", GL_FRAGMENT_SHADER);
