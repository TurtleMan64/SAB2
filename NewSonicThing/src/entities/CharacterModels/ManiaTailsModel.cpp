...
void ManiaTailsModel::loadStaticModels()
{
    ...
    loadModel(&ManiaTailsModel::modelHead,         "res/Models/Characters/ManiaTails/", "Head");
    loadModel(&ManiaTailsModel::modelLeftHumerus,  "res/Models/Characters/ManiaTails/", "Humerus");
    loadModel(&ManiaTailsModel::modelLeftForearm,  "res/Models/Characters/ManiaTails/", "Forearm");
    loadModel(&ManiaTailsModel::modelLeftHand,     "res/Models/Characters/ManiaTails/", "HandLeft");
    loadModel(&ManiaTailsModel::modelLeftThigh,    "res/Models/Characters/ManiaTails/", "Humerus");
    loadModel(&ManiaTailsModel::modelLeftShin,     "res/Models/Characters/ManiaTails/", "Forearm");
    loadModel(&ManiaTailsModel::modelLeftFoot,     "res/Models/Characters/ManiaTails/", "ShoeLeft");
    loadModel(&ManiaTailsModel::modelRightHumerus, "res/Models/Characters/ManiaTails/", "Humerus");
    loadModel(&ManiaTailsModel::modelRightForearm, "res/Models/Characters/ManiaTails/", "Forearm");
    loadModel(&ManiaTailsModel::modelRightHand,    "res/Models/Characters/ManiaTails/", "HandRight");
    loadModel(&ManiaTailsModel::modelRightThigh,   "res/Models/Characters/ManiaTails/", "Humerus");
