...
{
    #ifdef DEV_MODE
    printf("Loading PlayerTails static models...\n");
    #endif
...
{
    #ifdef DEV_MODE
    printf("Deleting PlayerTails static models...\n");
    #endif
...
void PlayerTails::hitSpringYellow(const Vector3f* direction, float power, float lockInputTime)
{
