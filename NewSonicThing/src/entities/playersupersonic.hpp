#ifndef PLAYERSUPERSONIC_H
#define PLAYERSUPERSONIC_H
...
class PlayerSuperSonic : public ControllablePlayer
{
private:
...
public:
    PlayerSuperSonic();
    PlayerSuperSonic(float x, float y, float z);
    ~PlayerSuperSonic();
