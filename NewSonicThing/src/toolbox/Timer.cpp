...
Timer::Timer(FontType* font, float posX, float posY, float scale, int alignment, bool visible)
{
	...
	this->minutes = new GUINumber(0, posX, posY, scale, alignment, visible, 2);
	this->colon = new GUIText(":", scale, font, posX + (0.118f / aspectRatio), posY, alignment, true);
	this->seconds = new GUINumber(0, posX + (0.15f / aspectRatio), posY, scale, alignment, visible, 2);
	this->dot = new GUIText(".", scale, font, posX + (0.268f / aspectRatio), posY, alignment, true);
	this->centiseconds = new GUINumber(0, posX + (0.30f / aspectRatio), posY, scale, alignment, visible, 2);
...
Timer::~Timer()
{
	...
	this->colon->deleteMe(); delete this->colon;
	this->dot->deleteMe(); delete this->dot;
	this->minutes->deleteMe(); delete this->minutes;
	this->seconds->deleteMe(); delete this->seconds;
	this->centiseconds->deleteMe(); delete this->centiseconds;
}
